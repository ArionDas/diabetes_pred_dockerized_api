...
diabetes_model = pickle.load(open('C:\my_folders\COMPUTER SCIENCE AND ENGINEERING\machine_learning\projects\dockerized_api\application_folder\model\diabetes_model.pkl', 'rb'))
